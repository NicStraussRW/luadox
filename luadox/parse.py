...
class Parser:
    ...
    def validate_enums(self) -> None:
        ...
        under the granular `undocumented-enum-fields` category rather than under a generic
        ...
        `allow_incomplete = undocumented-enum-fields` without loosening any other check, and
