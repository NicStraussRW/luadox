...
a `structure` error, and a fully undocumented one is reported under the suppressible
`undocumented` category (silence it with `allow_incomplete = undocumented`).  An `@enum`
